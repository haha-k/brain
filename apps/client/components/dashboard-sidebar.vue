...
>
    <div class="
        ...
        flex-items-center
    ">
        <div class="header-title flex content-center flex-items-center">
            <img
                class="w-28px h-28px"
                src="https://commonresource-1252524126.cdn.xiaoeknow.com/image/luzo8lg4083p.png"
                alt=""
            >
            <h2
                class="
    ...
    <div class="search-bar box-border mt-16px mb-16px flex">
        <UInput
            class="mr-12px"
        ...
        <el-dropdown>
            ...
            <template #dropdown>
                <el-dropdown-menu>
                    ...
                    <el-dropdown-item divided @click="handleCreateKnowledge">知识库</el-dropdown-item>
                    <!-- <el-dropdown-item divided>导入</el-dropdown-item> -->
                </el-dropdown-menu>
            </template>
        </el-dropdown>
    </div>
    <div class="menu__wrapper mb-24px">
        <NuxtLink
